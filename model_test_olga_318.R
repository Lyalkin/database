...
prediction_with318 = potential_with(c(1:19), clim_data)

prediction_without318 = potential_without(c(1:19), clim_data)
...
#require('graphics')
#mtext("Sugar Maple (Species 318) distribution", side=1)
...
pdf('Shapl_comparison_318.pdf', height=12, width=12)
par(mfrow=c(2,2))
