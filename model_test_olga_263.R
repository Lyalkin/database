...
prediction_with263 = potential_with(c(1:19), clim_data)

prediction_without263= potential_without(c(1:19), clim_data)
...
#require('graphics')
#mtext(" western hemlock (Species 263) distribution", side=1)
...
pdf('Shapl_comparison_263.pdf', height=12, width=12)
par(mfrow=c(2,2))
