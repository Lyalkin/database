...
prediction_with351 = potential_with(c(1:19), clim_data)

prediction_without351 = potential_without(c(1:19), clim_data)
...
#require('graphics')
#mtext("Red Alder (Species 351) distribution", side=1)
...
pdf('Shapl_comparison_351.pdf', height=12, width=12)
par(mfrow=c(2,2))
