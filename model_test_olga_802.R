...
prediction_with802 = potential_with(c(1:19), clim_data)

prediction_without802 = potential_without(c(1:19), clim_data)
...
#require('graphics')
#mtext("white Oak (Species 802) distribution", side=1)
...
pdf('Shapl_comparison_802.pdf', height=12, width=12)
par(mfrow=c(2,2))
